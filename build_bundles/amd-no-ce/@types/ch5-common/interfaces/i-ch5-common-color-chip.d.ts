...
import { ICh5AttributesColorChip } from "./i-ch5-common-attributes-color-chip";
export interface ICh5CommonAttributesColorChip extends ICh5CommonForDisabled, ICh5CommonForDebug, ICh5CommonForRole, ICh5CommonForStyle, ICh5CommonForClass, ICh5AttributesColorChip {
}
