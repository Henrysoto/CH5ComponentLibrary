...
import { ICh5CommonAttributesAnimation } from "./i-ch5-common-attributes-animation";
export interface ICh5CommonAttributesAnim extends ICh5CommonForDisabled, ICh5CommonForDebug, ICh5CommonForRole, ICh5CommonForStyle, ICh5CommonForClass, ICh5CommonAttributesAnimation {
}
