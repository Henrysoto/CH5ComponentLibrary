...
import { ICh5CommonAttributesSet3 } from "./i-ch5-common-attributes-set3";
export interface ICh5Common3 extends ICh5CommonForDisabled, ICh5CommonForDebug, ICh5CommonForRole, ICh5CommonForStyle, ICh5CommonForClass, ICh5CommonAttributesSet3 {
}
